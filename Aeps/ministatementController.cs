    ...
    public class ministatementController : ApiController
    {
        ...
        public HttpResponseMessage balanceinquiry(HttpRequestMessage request)
        {
           ...
           // Password = Convert.ToString(request.Headers.GetValues("ApiPassword").First());
            ...
            return balanceinquiry(requestString);
        }
        ...
        [AcceptVerbs("POST")]
        [HttpPost()]
        public HttpResponseMessage balanceinquiry(string request)
        {
            ...
            try
            {
                ...
                if ((apiKey!=null || apiKey!="") && requestIP!="")
                {
                    ...
                    if (validate)
                    {
                        obj = objProcessor.GetbalancerMiniStatement(objRQ);
                    }
                    else
                    {
                    ...
                    if (objProcessor.IsJson)
                    {
                        ...
                        Log.Error.LogLogin(Convert.ToString(objRQ.CompanyID), Convert.ToString(json), "MINIStatementResponse");
