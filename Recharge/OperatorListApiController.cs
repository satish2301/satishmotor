...
{
    public class OperatorListController : ApiController
    {
        // GET api/values
            ...
            try
            {
                ...
                if (request != null)
                {
                    ...
                    if (objProcessor.IsJson)
                    {
                        ...
                        Log.Error.LogLogin(Convert.ToString(CompanyId), Convert.ToString(requestString), "OperatorListRequest");
                    }
                    else
                    {
                    ...
                    if (validate)
                    {
                        ...
                        if (objProcessor.IsJson)
                        {
                            ...
                            Log.Error.LogLogin(Convert.ToString(CompanyId), Convert.ToString(response), "OperatorListResponse");
